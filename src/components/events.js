        ...
        <Grid>
          <Row className="show-grid">
            <Col md={4}>
              <Thumbnail
                alt="171x180"
                src="https://pbs.twimg.com/profile_images/1012542719661469696/0ReXCVXV_400x400.jpg"
                rounded
              />
            ...
            <Col md={4}>
              <Thumbnail
                alt="171x180"
                src="https://teenlife.s3.amazonaws.com/media/uploads/listings/BLqgL7cNrgto.jpg"
                rounded
              />
            ...
            <Col md={4}>
              <Thumbnail
                alt="171x180"
                src="http://weclipart.com/gimg/330CFA72211A0B7C/UW_Logo_University_of_Washington.jpg"
                rounded
              />
              <h4>Meetup Group</h4>
              <p>
